...
class RegistrationForm(forms.Form):
    ...
    phone = forms.CharField(max_length=15, widget=forms.TextInput(attrs={'class': 'form-input', 'id': 'reg_phone', 'placeholder': '9876543210'}))
    phone_verification_token = forms.CharField(required=False, widget=forms.HiddenInput(attrs={'id': 'reg_phone_verification_token'}))
