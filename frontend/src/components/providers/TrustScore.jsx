  ...
  return (
    <div className={cn('min-w-0', className)}>
      ...
      <div className="flex items-baseline gap-1">
        <span className="text-2xl font-extrabold text-ink">{numScore}</span>
      ...
      {showInfo && (
        <div className="mt-3 p-3 bg-page rounded-xl border border-line text-xs space-y-1.5 animate-fade-in">
          <p className="font-semibold text-ink mb-1">How is this calculated?</p>
          ...
          <div className="flex items-center gap-2 text-muted"><Shield size={12} className="text-brand shrink-0" /> Verification: {verified ? 'Verified' : 'Pending'}</div>
